...
- **Vitest (web)**: the optimistic `setTaskLabels` + `createLabel` recipes (patch/rollback/settle); the selector assembly (toggle, type-to-create); chip rendering (name present, color not sole meaning).
