...
/// <c>SetTaskStatus</c> command. Named to match the OpenAPI schema component so the auto-emitted client
...
{
    /// <summary>The DESIRED status — the full FR-003 enum (<c>backlog | todo | in_progress | done | cancelled</c>, slice 010 D3); any other target → 422.</summary>
