...
namespace TaskFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260816234439_AddCycles")]
    partial class AddCycles
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Domain.TaskManagement.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("TaskFlow.Domain.TaskManagement.Label", b =>
                {
                    ...
                    b.HasIndex("OwnerId", "NameNormalized")
                        .IsUnique()
            ...
            modelBuilder.Entity("TaskFlow.Domain.TaskManagement.TaskLabel", b =>
                {
                    b.Property<Guid>("TaskId")
                        .HasColumnType("uuid")
                        .HasColumnName("task_id");
            ...
            modelBuilder.Entity("TaskFlow.Domain.TaskManagement.Comment", b =>
                {
                    ...
                    b.HasOne("TaskFlow.Domain.TaskManagement.Task", null)
                        .WithMany()
                        .HasForeignKey("TaskId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsMany("TaskFlow.Domain.TaskManagement.CommentMention", "Mentions", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                            ...
                            b1.HasIndex("CommentId", "UserId")
                                .IsUnique()
                                .HasDatabaseName("ux_comment_mentions_comment_user");

                            b1.ToTable("comment_mentions", (string)null);
            ...
            modelBuilder.Entity("TaskFlow.Domain.TaskManagement.TaskLabel", b =>
                {
                    b.HasOne("TaskFlow.Domain.TaskManagement.Label", null)
                        .WithMany()
